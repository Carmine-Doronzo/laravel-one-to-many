    ...
    <div class="container">
        <a class="navbar-brand d-flex align-items-center" href="{{ url('/') }}">
            <div class="logo_laravel">
                <img width="70" height="70" src="https://img.icons8.com/external-icongeek26-glyph-icongeek26/64/64a775/external-swan-origami-icongeek26-glyph-icongeek26.png" alt="external-swan-origami-icongeek26-glyph-icongeek26"/>
            </div>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav me-auto">
                <li class="nav-item">
                    <a class="nav-link" style="display: none" href="{{url('/') }}">{{ __('Home') }}</a>
                </li>
            </ul>
